...
import DirectorFormRegister from "../components/Forms/DirectorFormRegister";
        ...
        const message =
          errorData && typeof errorData === "object"
            ? Object.values(errorData)
                ...
                .join(" ")
            : "Não foi possível cadastrar o diretor.";

        throw new Error(message || "Não foi possível cadastrar o diretor.");
      }
  ...
  return (
    <div className="bg-gray-950">
      ...
      <fieldset disabled={isSubmitting} className="disabled:opacity-60">
        <DirectorFormRegister onSubmit={handleSubmit} />
      </fieldset>
    </div>
  );
};
