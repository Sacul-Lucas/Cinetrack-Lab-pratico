...
interface DirectorFormRegisterProps {
  onSubmit?: (data: FormData) => void;
}

export default function DirectorFormRegister({
  onSubmit,
}: DirectorFormRegisterProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-950 px-4 py-10 text-white">
      <div className="mx-auto max-w-2xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">Cadastrar diretor</h1>
          <p className="mt-2 text-gray-400">
            Preencha as informações do diretor para realizar o cadastro.
          </p>
        </div>
